...
lstseqs = ['48506274', '48506403', '48506426', '48506350', '48506443']

for camid, lstseq in zip(camids, lstseqs):
	...
	for seq, data in all_passages.items():
		if seq in pool:
			passages[seq] = {}
			for satnum in pool[seq]:
				if satnum in data:
					passages[seq][satnum] = data[satnum]
	...
	plt.savefig(f'{rootdir}error_tests/vmags_{target}.png', bbox_inches='tight', dpi=150, facecolor='w')
